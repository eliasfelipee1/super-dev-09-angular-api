...
export class TarefaEditar {
  ...
  // Inject é uma forma que o angular tem de entregar no componente uma instancia daquela classe
  ...
  constructor(private activeRoute: ActivatedRoute, private router: Router) {
    ...
    this.tarefa.update(tarefa => ({
      // decomposição do objeto da tarefa para popular o signal com os dados atuais
      ...tarefa,
      // modificando o id que pegamos da URL
      id: idParaEditar
    }));
